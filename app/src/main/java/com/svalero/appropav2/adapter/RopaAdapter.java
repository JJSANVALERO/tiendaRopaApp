...
public class RopaAdapter extends RecyclerView.Adapter<RopaAdapter.RopaHolder>
    ...
    public RopaAdapter(Context context, List<Ropa> dataList) {
        ...
        this.token = token;
//        deleteRopaPresenter = new DeleteRopaPresenter(this);
    ...
    public void onBindViewHolder(RopaHolder holder, int position) {
        ...
        holder.precioPrenda.setText((int) listaRopa.get(position).getPrecio());
        holder.fechaAltaPrenda.setText(listaRopa.get(position).getFechaAlta());
...
//        Intent intent = new Intent(context, RopaDetailsView.class);
//        intent.putExtra("idArticulo", ropa.getIdArticulo());
